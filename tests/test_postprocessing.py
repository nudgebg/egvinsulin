...
def cleaned_basal():
    return pd.DataFrame({
        ...
        'datetime': pd.to_datetime(['01/01/2023 8:00:00 AM', '01/01/2023 12:30:00 PM', '01/01/2023 9:00:00 AM', '01/03/2023 4:00:00 PM',
                                    '01/01/2023 10:13:33 AM', '01/01/2023 2:19:22 PM', '01/02/2023 6:12:30 PM', '01/02/2023 8:07:00 PM']),
        'basal_rate': [1.3, 2, 0.7, 1.5, 0.1, 4, 0.75, 0.2]
    })
...
def cleaned_cgm():
    return pd.DataFrame({
        ...
        'cgm': [100.0, 110.0, 105.0, 120.0, 130.0, 140.0, 105.0, 150.0, 160.0, 170.0, 155.0]
    })
...
def test_cgm_transform(cleaned_cgm):
    ...
    pytest.fail("Validation for transformed CGM data is missing")
...
def test_bolus_transform(cleaned_bolus):
    ...
    # Add validation checks here
    pytest.fail("Validation for transformed bolus data is missing")
...
def test_basal_transform(cleaned_basal):
    ...
    # Add validation checks here
    pytest.fail("Validation for transformed basal data is missing")